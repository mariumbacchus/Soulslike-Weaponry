...
public class PredicateRegistry {
    ...
    public static void initClient() {
        ...
        ModelPredicateProviderRegistry.register(WeaponRegistry.DRAUGR, new Identifier("night"), (ItemStack itemStack, ClientWorld clientWorld, LivingEntity livingEntity, int number) -> {
            if (livingEntity != null && livingEntity.method_48926().getDimension().hasSkyLight() && livingEntity.method_48926().getTimeOfDay() % 24000 > 13000 && livingEntity.method_48926().getTimeOfDay() % 24000 < 23000) {
