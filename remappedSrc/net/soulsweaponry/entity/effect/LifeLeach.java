...
public class LifeLeach extends StatusEffect {
    ...
    public void applyUpdateEffect(LivingEntity entity, int amplifier) {
        ...
        if (entity.method_48926().isClient) {
            for (int i = 0; i < 30; i++) {
                entity.method_48926().addParticle(ParticleRegistry.DARK_STAR, entity.getParticleX(1D), entity.getBodyY(0.5) + entity.getRandom().nextDouble() * 2 - 1D, entity.getParticleZ(1D), 0, 0, 0);
            }
        }
        if (target != null) {
