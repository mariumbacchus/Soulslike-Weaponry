...
public class FreyrSwordEntity extends TameableEntity implements GeoEntity {
    ...
    public LivingEntity getOwner() {
        try {
            ...
            LivingEntity owner = uUID == null ? null : this.method_48926().getPlayerByUuid(uUID);
    ...
    public void onDeath(DamageSource damageSource) {
        if (!method_48926().isClient && this.getBlockPos() != null) {
            this.method_48926().playSound(null, this.getBlockPos(), SoundEvents.ENTITY_ITEM_BREAK, SoundCategory.PLAYERS, 1f, 1f);
    ...
    public void tickMovement() {
        ...
        if (this.age % 4 == 0) {
            ...
            this.method_48926().addParticle(ParticleTypes.GLOW, false,
