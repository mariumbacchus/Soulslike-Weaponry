...
public class Soulmass extends Remnant implements GeoEntity, IAnimatedDeath {
    ...
    public void updatePostDeath() {
        ...
        if (this.deathTicks >= this.getTicksUntilDeath() && !this.method_48926().isClient()) {
            ...
            CustomDeathHandler.deathExplosionEvent(this.method_48926(), this.getPos(), SoundRegistry.DAWNBREAKER_EVENT, ParticleRegistry.PURPLE_FLAME, ParticleTypes.SOUL_FIRE_FLAME, ParticleTypes.LARGE_SMOKE);
            this.sacrificeEvent();
    ...
    public void sacrificeEvent() {
        ...
        for (Entity nearbyEntity : nearbyEntities) {
            if (nearbyEntity instanceof HostileEntity) {
                ...
                closestTarget.damage(this.method_48926().getDamageSources().magic(), 16F);
            }
        }
    }
    ...
    public boolean hasSummonsAlive() {
        if (!this.method_48926().isClient) {
            for (int id : summonIds) {
                if (method_48926().getEntityById(id) != null) {
                    return true;
                }
            }
        }
    ...
    static class SoulmassGoal extends Goal {
            ...
            if (target != null) {
                ...
                if (this.entity.getSmash()) {
                    ...
                    if (this.attackStatus == 10) {
                        ...
                        for (int[] cord : cords) {
                            ...
                            if (!this.entity.method_48926().isClient) {
                                ParticleHandler.particleOutburstMap(this.entity.method_48926(), 50, pos.getX(), pos.getY(), pos.getZ(), ParticleEvents.CONJURE_ENTITY_MAP, 1f);
                            }

                            this.entity.method_48926().playSound(null, target.getBlockPos(), SoundRegistry.NIGHTFALL_SPAWN_EVENT, SoundCategory.PLAYERS, 0.6f, 1f);
                            SoulReaperGhost mob = new SoulReaperGhost(EntityRegistry.SOUL_REAPER_GHOST, this.entity.method_48926());
                            mob.setSoulAmount(0);
                            ...
                            this.entity.method_48926().spawnEntity(mob);
                        }
                    } else if (this.attackStatus >= 20) {
                        this.entity.setSmash(false);
                ...
                if (this.entity.getBeaming()) {
                    ...
                    if (attackStatus % 5 == 0 && distanceToEntity < 130f) {
                        target.damage(this.entity.method_48926().getDamageSources().mobAttack(this.entity), 6f);
                        this.entity.heal(2f);
                        this.entity.method_48926().playSound(null, target.getBlockPos(), SoundEvents.ENTITY_BLAZE_SHOOT, SoundCategory.PLAYERS, 1f, 1f);
                    }
                }
        ...
        private void conjureFangs(double x, double z, double maxY, double y, float yaw, int warmup) {
            ...
            do {
                ...
                if (!(blockState = this.entity.method_48926().getBlockState(blockPos2 = blockPos.down())).isSideSolidFullSquare(this.entity.method_48926(), blockPos2, Direction.UP)) continue;
                if (!this.entity.method_48926().isAir(blockPos) && !(voxelShape = (blockState2 = this.entity.method_48926().getBlockState(blockPos)).getCollisionShape(this.entity.method_48926(), blockPos)).isEmpty()) {
            ...
            if (bl) {
                this.entity.method_48926().spawnEntity(new EvokerFangsEntity(this.entity.method_48926(), x, (double)blockPos.getY() + d, z, yaw, warmup, this.entity));
            }
        }
    }
    ...
    public void tickMovement() {
        super.tickMovement();
        this.method_48926().addParticle(ParticleTypes.LARGE_SMOKE, this.getParticleX(0.5D), this.getRandomBodyY(), this.getParticleZ(0.5D), 0.0D, 0.0D, 0.0D);
    }
    ...
    public void tick() {
        ...
        if (this.isSneaking() && !this.isDead()) {
            this.soulCircle(this.method_48926(), this.getX(), this.getEyeY() + 1.0F, this.getZ());
            ...
            for (int i = 0; i < 10; i++) {
                ...
                this.method_48926().addParticle(ParticleTypes.SOUL_FIRE_FLAME, this.getX() + e * j, this.getEyeY() + 1 + f * j, this.getZ() + g * j, 0.0D, 0.0D, 0.0D);
                this.method_48926().addParticle(ParticleTypes.SOUL, this.getX() + e * j, this.getEyeY() + 1 + f * j, this.getZ() + g * j, 0.0D, 0.0D, 0.0D);
            }
            this.soulCircle(this.method_48926(), this.getX(), this.getEyeY() + 1.0F, this.getZ());
        }
    }
