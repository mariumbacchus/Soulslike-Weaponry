...
public class RimeSpectre extends Remnant implements GeoEntity, IAnimatedDeath {
    ...
    public void tick() {
        ...
        for (Entity entity : this.method_48926().getOtherEntities(this, this.getBoundingBox().expand(6D))) {
        ...
        if (this.getShootingParticle()) {
            ...
            for (int i = 0; i < 20; i++) {
                ...
                if (this.method_48926().isClient) {
                    method_48926().addParticle(ParticleTypes.SNOWFLAKE, this.getX(), this.getEyeY(), this.getZ(), (e + this.getRandom().nextGaussian() * h)/4f, (f + this.getRandom().nextGaussian())/4f, (g + this.getRandom().nextGaussian() * h)/4f);
                }
            }
        }
    }
        ...
        private void frostBeam(LivingEntity target) {
            ...
            if (attackStatus >= 15) {
                ...
                if (attackStatus % 2 == 0) {
                    ...
                    for (Entity entity : this.mob.method_48926().getOtherEntities(this.mob, box)) {
                        if (entity instanceof LivingEntity living && !this.mob.isOwner(living) && !this.mob.isTeammate(living)) {
                            ...
                            living.damage(mob.method_48926().getDamageSources().mobAttack(this.mob), 2f);
                        }
                    }
                }
            }
