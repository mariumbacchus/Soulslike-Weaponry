...
public class ChaosMonarch extends BossEntity implements GeoEntity {
    ...
    public void updatePostDeath() {
        ...
        if (this.deathTicks >= this.getTicksUntilDeath() && !this.method_48926().isClient()) {
            ...
            CustomDeathHandler.deathExplosionEvent(this.method_48926(), this.getPos(), SoundRegistry.DAWNBREAKER_EVENT, ParticleTypes.LARGE_SMOKE, ParticleTypes.DRAGON_BREATH, ParticleRegistry.PURPLE_FLAME);
    ...
    public void tickMovement() {
        ...
        if (this.getAttack() == Attack.SPAWN) {
            ...
            if (this.spawnTicks == 40) {
                ...
                this.method_48926().playSound(null, this.getBlockPos(), SoundEvents.ENTITY_WITHER_DEATH, SoundCategory.HOSTILE, 1f, 1f);
            }
    ...
    public boolean damage(DamageSource source, float amount) {
        if (source == (this.method_48926().getDamageSources().lightningBolt())) {
            return false;
        }
    ...
    protected void mobTick() {
        ...
        if (this.hasStatusEffect(EffectRegistry.DECAY) && this.age % 10 == 0) {
            ...
            for (LivingEntity target : this.method_48926().getNonSpectatingEntities(LivingEntity.class, this.getBoundingBox().expand(3D))) {
        ...
        this.turnBlocks(this.method_48926(), this.getBlockPos());
    }
    ...
    private void particleExplosion(DefaultParticleType[] particles, float sizeModifier) {
        this.roundParticleOutburst(this.method_48926(), 1000, particles, this.getX(), this.getY() + 3, this.getZ(), sizeModifier);
    }
