...
public class WarmthEntity extends TameableEntity implements GeoEntity {
    ...
    public void tickMovement() {
        if (this.method_48926().isClient) {
            this.method_48926().addParticle(ParticleTypes.FLAME, this.getParticleX(0.5), this.getRandomBodyY(), this.getParticleZ(0.5), 0.0, 0.0, 0.0);
        }
        super.tickMovement();
    }
    ...
    private void particleExplosion() {
        ...
        for (int i = 0; i < points; i++) {
            ...
            method_48926().addParticle(ParticleTypes.FLAME, true, this.getX(), this.getBodyY(0.5D), this.getZ(), velocityX*0.4f, velocityY*0.4f, velocityZ*0.4f);
        }
    }
    ...
    static class WarmthEntityGoal
        ...
        private void shootFire(LivingEntity livingEntity) {
            ...
            if (this.attackStatus == 7 || this.attackStatus == 15 || this.attackStatus == 21) {
                this.entity.method_48926().playSound(null, this.entity.getBlockPos(), SoundEvents.ENTITY_BLAZE_SHOOT, SoundCategory.HOSTILE, 1f, 1f);
                SmallFireballEntity smallFireballEntity = new SmallFireballEntity(this.entity.method_48926(), this.entity, e, f, g);
                smallFireballEntity.setPosition(smallFireballEntity.getX(), this.entity.getBodyY(0.5f), smallFireballEntity.getZ());
                this.entity.method_48926().spawnEntity(smallFireballEntity);
            }
        ...
        private void buff() {
            this.attackStatus++;
            if (attackStatus == 1) this.entity.method_48926().playSound(null, this.entity.getBlockPos(), SoundEvents.ENTITY_GUARDIAN_ATTACK, SoundCategory.HOSTILE, 1f, 1f);
            if (attackStatus == 30) this.entity.method_48926().playSound(null, this.entity.getBlockPos(), SoundRegistry.WARMTH_BUFF_EVENT, SoundCategory.HOSTILE, 1f, 1f);
            if (this.attackStatus == 35) {
                boolean bl = this.entity.isTamed() && this.entity.getOwner() != null;
                    for (Entity en : this.entity.method_48926().getOtherEntities(this.entity, this.entity.getBoundingBox().expand(16D))) {
