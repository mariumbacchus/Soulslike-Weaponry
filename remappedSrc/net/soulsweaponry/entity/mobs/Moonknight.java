...
public class Moonknight extends BossEntity implements GeoEntity {
    ...
    public boolean damage(DamageSource source, float amount) {
        ...
        if (!this.isPhaseTwo() && this.getHealth() - amount < 1f) {
            ...
            method_48926().playSound(null, this.getBlockPos(), SoundRegistry.KNIGHT_DEATH_EVENT, SoundCategory.HOSTILE, 1f, 1f);
            return false;
        }
           ...
           return false;
            ...
            if (entity instanceof ProjectileEntity && entity.getBlockPos() != null) {
                if (!this.method_48926().isClient) {
                    ParticleHandler.particleSphereList(this.method_48926(), 10, entity.getX(), entity.getY(), entity.getZ(), ParticleEvents.DARK_EXPLOSION_LIST, 1f);
                }
                return false;
            }
    ...
    protected void mobTick() {
        ...
        if (this.isInitiatingPhaseTwo()) {
            ...
            if (this.phaseTransitionTicks == 89) {
                CustomDeathHandler.deathExplosionEvent(this.method_48926(), this.getPos(), SoundRegistry.DAWNBREAKER_EVENT, ParticleRegistry.NIGHTFALL_PARTICLE, ParticleTypes.SOUL_FIRE_FLAME, ParticleTypes.LARGE_SMOKE);
            }
    ...
    public void tickMovement() {
        ...
        if (!this.isDead() && !this.isPhaseTwo() && this.getUnbreakable()) {
            ...
            if (this.unbreakableTicks == 38) {
                this.method_48926().playSound(null, this.getBlockPos(), SoundRegistry.NIGHTFALL_SHIELD_EVENT, SoundCategory.HOSTILE, .75f, 1f);
                for (Entity entity : method_48926().getOtherEntities(this, this.getBoundingBox().expand(20))) {
        ...
        if (this.isPhaseTwo() && this.getPhaseTwoAttack().equals(MoonknightPhaseTwo.CORE_BEAM) && this.getCanBeam() && !this.isPosNullish(this.getBeamLocation())) {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                this.method_48926().addParticle(ParticleTypes.SOUL_FIRE_FLAME, this.getX() + e * length, this.getEyeY() + f * length, this.getZ() + g * length, (double)this.random.nextBetween(-points, points)/spreader, (double)this.random.nextBetween(-points, points)/spreader, (double)this.random.nextBetween(-points, points)/spreader);
                this.method_48926().addParticle(ParticleTypes.SOUL_FIRE_FLAME, this.getX() + e * length, this.getEyeY() + f * length, this.getZ() + g * length, (double)this.random.nextBetween(-points, points)/spreader, (double)this.random.nextBetween(-points, points)/spreader, (double)this.random.nextBetween(-points, points)/spreader);
                this.method_48926().addParticle(ParticleTypes.GLOW, this.getX() + e * length, this.getEyeY() + f * length, this.getZ() + g * length, (double)this.random.nextBetween(-points, points)/spreader, (double)this.random.nextBetween(-points, points)/spreader, (double)this.random.nextBetween(-points, points)/spreader);
                this.method_48926().addParticle(ParticleTypes.WAX_OFF, this.getX() + e * length, this.getEyeY() + f * length, this.getZ() + g * length, (double)this.random.nextBetween(-points, points)/10, (double)this.random.nextBetween(-points, points)/10, (double)this.random.nextBetween(-points, points)/10);
                //Looks like wind blows particles away
                this.method_48926().addParticle(ParticleTypes.SOUL_FIRE_FLAME, this.getX() + e * length, this.getEyeY() + f * length, this.getZ() + g * length, this.random.nextDouble() - .05f, this.random.nextDouble() - .05f, this.random.nextDouble() - .05f);
            }
        ...
        if (this.isPhaseTwo() && !this.isDead() && this.isSwordCharging()) {
            ...
            for (int i = 0; i < 100; i++) {
                this.method_48926().addParticle(ParticleRegistry.NIGHTFALL_PARTICLE, this.getParticleX(this.getWidth()), this.getRandomBodyY(), this.getParticleZ(this.getWidth()), 0.0D, 0.2D, 0.0D);
            }
        }
    }
    ...
    private void summonParticles() {
        if (method_48926().isClient) {
            for(int i = 0; i < 50; ++i) {
                ...
                method_48926().addParticle(ParticleTypes.SOUL, this.getX(), this.getY(), this.getZ(), newX/2, newY/2, newZ/2);
                method_48926().addParticle(ParticleTypes.LARGE_SMOKE, this.getX(), this.getY(), this.getZ(), newX/2, newY/2, newZ/2);
            }
        } else {
            ParticleHandler.particleOutburstMap(this.method_48926(), 50, this.getX(), this.getY(), this.getZ(), ParticleEvents.OBLITERATE_MAP, 1f);
        }
    }
    ...
    public void updatePostDeath() {
        this.deathTicks++;
        if (this.deathTicks == 40 && this.getBlockPos() != null) this.method_48926().playSound(null, this.getBlockPos(), SoundRegistry.KNIGHT_DEATH_LAUGH_EVENT, SoundCategory.HOSTILE , 1f, 1f);
