...
public class FrostGiant extends Remnant implements GeoEntity, IAnimatedDeath {
    ...
    public void onDeath(DamageSource damageSource) {
        LeviathanAxe.iceExplosion(this.method_48926(), this.getBlockPos(), null, 1);
    ...
    public void updatePostDeath() {
        ...
        if (this.deathTicks >= this.getTicksUntilDeath() && !this.method_48926().isClient()) {
            ...
            if (!method_48926().isClient) {
                ParticleHandler.particleSphere(this.method_48926(), 600, this.getX(), this.getY() + .5f, this.getZ(), ParticleEvents.ICE_PARTICLE, 1f);
            }
            this.method_48926().playSound(null, this.getBlockPos(), SoundEvents.BLOCK_GLASS_BREAK, SoundCategory.HOSTILE, 1f, 1f);
            this.method_48926().playSound(null, this.getBlockPos(), SoundEvents.BLOCK_GLASS_BREAK, SoundCategory.HOSTILE, 1f, .5f);
            ...
            if (target != null) {
                ...
                if (this.mob.isSmashing()) {
                    ...
                    if (this.attackStatus == 32) {
                        for (Entity entity : this.mob.method_48926().getOtherEntities(this.mob, this.mob.getBoundingBox().expand(3.5D))) {
                        ...
                        if (!this.mob.method_48926().isClient) {
                            ParticleHandler.particleOutburstMap(mob.method_48926(), 150, mob.getX(), mob.getY(), mob.getZ(), ParticleEvents.ICE_SMASH_MAP, 1f);
                        }
                        this.mob.method_48926().playSound(null, this.mob.getBlockPos(), SoundEvents.BLOCK_GLASS_BREAK, SoundCategory.HOSTILE, 1f, 1f);
                        this.mob.method_48926().playSound(null, this.mob.getBlockPos(), SoundEvents.BLOCK_GLASS_BREAK, SoundCategory.HOSTILE, 1f, .5f);
                        this.mob.method_48926().playSound(null, this.mob.getBlockPos(), SoundEvents.ENTITY_GENERIC_EXPLODE, SoundCategory.HOSTILE, 1f, 1f);
                    }
                    if (attackStatus >= 51) {
                        this.mob.setSmash(false);
                        this.attackStatus = 0;
