...
public class AreaEffectSphere extends Entity implements Ownable {
    ...
    public void tick() {
        ...
        if (this.method_48926().isClient) {
            ...
            randomParticleBox(this.method_48926(), this.getX(), this.getY() + this.getHeight()/2f, this.getZ(), points, this.getRadius() * 1.25f, this.getParticleType(), this.random);
        } else {
            ...
            if (this.age % 5 == 0) {
                ...
                if (list.isEmpty()) {
                    ...
                    List<LivingEntity> list2 = this.method_48926().getNonSpectatingEntities(LivingEntity.class, this.getBoundingBox());
                    if (!list2.isEmpty()) {
    ...
    public LivingEntity getOwner() {
        if (this.owner == null && this.ownerUuid != null && this.method_48926() instanceof ServerWorld) {
            Entity entity = ((ServerWorld)this.method_48926()).getEntity(this.ownerUuid);
