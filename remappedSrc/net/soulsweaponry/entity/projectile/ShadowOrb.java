...
public class ShadowOrb extends AbstractFireballEntity implements GeoEntity {
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        if (entity instanceof LivingEntity target && this.getOwner() instanceof LivingEntity) {
            target.damage(CustomDamageSource.create(this.method_48926(), CustomDamageSource.SHADOW_ORB, this, this.getOwner()), 5f);
    ...
    public void tick() {
        ...
        this.method_48926().addParticle(ParticleTypes.ENTITY_EFFECT, d + random.nextDouble() - .5D, e + random.nextDouble() - .5D, f + random.nextDouble() - .5D, 0.0, 0.0, 0.0);
    }
    ...
    protected void onCollision(HitResult hitResult) {
        ...
        if (!this.method_48926().isClient) {
            ParticleHandler.particleSphereList(this.method_48926(), 10, this.getX(), this.getY(), this.getZ(), ParticleEvents.DARK_EXPLOSION_LIST, 1f);
            this.discard();
        }
    }
