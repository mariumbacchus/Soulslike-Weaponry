...
public class DragonStaffProjectile extends DragonFireballEntity {
    ...
    private void detonate() {
        if (!this.method_48926().isClient) {
            List<LivingEntity> list = this.method_48926().getNonSpectatingEntities(LivingEntity.class, this.getBoundingBox().expand(4.0, 2.0, 4.0));
            AreaEffectSphere areaEffectCloudEntity = new AreaEffectSphere(this.method_48926(), this.getX(), this.getY(), this.getZ());
            ...
            this.method_48926().syncWorldEvent(WorldEvents.DRAGON_BREATH_CLOUD_SPAWNS, this.getBlockPos(), this.isSilent() ? -1 : 1);
