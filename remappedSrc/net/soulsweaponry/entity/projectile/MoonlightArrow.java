...
public class MoonlightArrow extends PersistentProjectileEntity {
    ...
    public void tick() {
        if (!this.inGround) {
            ...
            double g = vec3d.z;
            for (int i = 0; i < 4; ++i) {
                this.method_48926().addParticle(this.getParticleType(), this.getX() + e * (double)i / 4.0D, this.getY() + f * (double)i / 4.0D, this.getZ() + g * (double)i / 4.0D, 0, 0, 0); //-e, -f + 0.2D, -g
            }
        }
        super.tick();
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        if ((entity2 = this.getOwner()) == null) {
            damageSource = method_48926().getDamageSources().indirectMagic(this, this);
        } else {
            damageSource = method_48926().getDamageSources().indirectMagic(this, entity2);
        ...
        if (entity.damage(damageSource, i)) {
            ...
            if (entity instanceof LivingEntity livingEntity) {
                Vec3d vec3d;
                if (!this.method_48926().isClient && this.getPierceLevel() <= 0) {
                ...
                if (!this.method_48926().isClient && entity2 instanceof LivingEntity) {
                ...
                if (!this.method_48926().isClient && entity2 instanceof ServerPlayerEntity serverPlayerEntity) {
            ...
            this.prevYaw += 180.0f;
            if (!this.method_48926().isClient && this.getVelocity().lengthSquared() < 1.0E-7) {
