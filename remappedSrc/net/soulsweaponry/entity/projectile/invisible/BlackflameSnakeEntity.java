...
public class BlackflameSnakeEntity extends InvisibleEntity {
    ...
    public void tick() {
        ...
        if (!this.method_48926().isClient) {
            if ((target = this.getSavedTarget((ServerWorld) this.method_48926())) != null) {
            ...
            if (this.age % 4 == 0) {
                for (Entity entity : this.method_48926().getOtherEntities(this, this.getBoundingBox())) {
                    if (entity instanceof LivingEntity living && !this.isOwner(living) && !(entity instanceof NightProwler)) {
                        if (living.damage(this.method_48926().getDamageSources().mobProjectile(this, (LivingEntity) this.getOwner()), (float) this.getDamage())) {
                ...
                ParticleHandler.particleOutburstMap(this.method_48926(), 250, this.getX(), this.getY(), this.getZ(), ParticleEvents.BLACKFLAME_SNAKE_PARTICLE_MAP, 1f);
            }
        }
        if (this.age > 100 || this.hasHitPlayer) {
            this.method_48926().createExplosion(this, this.getX(), this.getY(), this.getZ(), 2f, true, World.ExplosionSourceType.TNT);
            this.discard();
        }
    }
