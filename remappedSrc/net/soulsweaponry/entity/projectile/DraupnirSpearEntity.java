...
public class DraupnirSpearEntity extends PersistentProjectileEntity implements GeoEntity {
    ...
    public void detonate() {
        if (this.getOwner() != null && this.getBlockPos() != null && !method_48926().isClient) {
            ...
            this.method_48926().createExplosion(this.getOwner(), this.getX(), this.getY(), this.getZ(), power, false, World.ExplosionSourceType.NONE);
            if (power > 2f) {
                for (Entity entity : method_48926().getOtherEntities(this.getOwner(), this.getBoundingBox().expand(power))) {
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        DamageSource damageSource = this.method_48926().getDamageSources().thrown(this, entity2);
