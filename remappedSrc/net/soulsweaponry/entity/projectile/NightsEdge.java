...
public class NightsEdge extends PathAwareEntity implements Ownable, GeoEntity {
        ...
        if (!this.method_48926().isClient) {
            ...
            if (this.getWarmup() < 0) {
                ...
                if (!this.startedAttack) {
                    this.method_48926().sendEntityStatus(this, EntityStatuses.PLAY_ATTACK_SOUND);
    ...
    public void handleStatus(byte status) {
        ...
        if (status == EntityStatuses.PLAY_ATTACK_SOUND) {
            if (!this.isSilent()) {
                this.method_48926().playSound(this.getX(), this.getY(), this.getZ(), SoundEvents.ENTITY_EVOKER_FANGS_ATTACK, this.getSoundCategory(), 1.0f, this.random.nextFloat() * 0.2f + 0.85f, false);
            }
        }
    }
    ...
    public LivingEntity getOwner() {
        Entity entity;
        if (this.owner == null && this.ownerUuid != null && this.method_48926() instanceof ServerWorld && (entity = ((ServerWorld)this.method_48926()).getEntity(this.ownerUuid)) instanceof LivingEntity) {
