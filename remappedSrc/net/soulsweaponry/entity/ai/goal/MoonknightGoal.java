...
public class MoonknightGoal extends Goal {
    ...
    private void coreBeam(LivingEntity target) {
        this.attackStatus++;
        if (attackStatus == 1) this.boss.method_48926().playSound(null, this.boss.getBlockPos(), SoundEvents.ENTITY_GUARDIAN_ATTACK, SoundCategory.HOSTILE, 1f, 1f);
        ...
        if (this.targetPos != null) {
            ...
            if (this.attackStatus >= 21 && this.attackStatus <= 47) {
                if (attackStatus == 21) this.boss.method_48926().playSound(null, this.boss.getBlockPos(), SoundRegistry.KNIGHT_CORE_BEAM_EVENT, SoundCategory.HOSTILE, 1f, 1f);
                ...
                if (this.attackStatus % 2 == 0) {
                    this.boss.method_48926().createExplosion(boss, CustomDamageSource.create(this.boss.method_48926(), CustomDamageSource.BEAM, this.boss), null, targetPos.getX(), targetPos.getY() + this.bonusBeamHeight, targetPos.getZ(), 2f, true, this.boss.method_48926().getGameRules().getBoolean(GameRules.DO_MOB_GRIEFING) ? World.ExplosionSourceType.TNT : World.ExplosionSourceType.NONE);
                    for (Entity entity : this.boss.method_48926().getOtherEntities(boss, new Box(targetPos, this.boss.getBlockPos().add(0, 4, 0)))) {
                        if (entity instanceof LivingEntity) {
                            entity.damage(CustomDamageSource.create(this.boss.method_48926(), CustomDamageSource.BEAM, this.boss), this.getModifiedDamage(20f));
    ...
    private void swordOfLight(LivingEntity target) {
        ...
        if (this.targetPos != null && target.getPos() != null) {
            ...
            if (attackStatus == 8 || attackStatus == 15 || attackStatus == 20 || attackStatus == 25) {
                this.boss.method_48926().playSound(null, this.boss.getBlockPos(), SoundEvents.ENTITY_PLAYER_ATTACK_SWEEP, SoundCategory.HOSTILE, 1f, 0.75f);
                for (Entity entity : this.boss.method_48926().getOtherEntities(boss, new Box(this.targetPos).expand(3))) {
                    if (entity instanceof LivingEntity) {
                        entity.damage(this.boss.method_48926().getDamageSources().mobAttack(boss), this.getModifiedDamage(25f));
                        ((LivingEntity) entity).takeKnockback(2f, -(entity.getX() - this.boss.getX()), -(entity.getZ() - this.boss.getZ()));
                    }
                }

                this.boss.method_48926().playSound(null, this.targetPos, SoundRegistry.MOONLIGHT_BIG_EVENT, SoundCategory.HOSTILE, 1f, 1f);
            ...
            if (attackStatus == 27) this.boss.method_48926().playSound(null, this.targetPos, SoundRegistry.KNIGHT_SWORD_SMASH_EVENT, SoundCategory.HOSTILE, 1f, 1f);
            if (attackStatus == 31) {
                this.smashGround(30f, SoundRegistry.KNIGHT_SWORD_SMASH_EVENT, true);
                this.boss.method_48926().playSound(null, this.targetPos, SoundRegistry.MOONLIGHT_BIG_EVENT, SoundCategory.HOSTILE, 1f, 0.75f);
    ...
    private void thrustLogic(LivingEntity target) {
        attackStatus++;
        if (attackStatus == 1) this.boss.method_48926().playSound(null, this.boss.getBlockPos(), SoundRegistry.KNIGHT_CHARGE_SWORD_EVENT, SoundCategory.HOSTILE, 1f, 1f);
        if (this.attackStatus < 1) this.boss.method_48926().playSound(null, this.boss.getBlockPos(), SoundEvents.ENTITY_GUARDIAN_ATTACK, SoundCategory.HOSTILE, 1f, 1f);
        if (this.attackStatus < 13 && target.getBlockPos() != null) {
            ...
            this.boss.getNavigation().startMovingTo(this.targetPos.getX(), this.targetPos.getY(), this.targetPos.getZ(), 0.0D);
            this.boss.addStatusEffect(new StatusEffectInstance(StatusEffects.SLOWNESS, 5, 20));
            if (attackStatus == 15) this.boss.method_48926().playSound(null, targetPos, SoundRegistry.KNIGHT_THRUST_SWORD_EVENT, SoundCategory.HOSTILE, 1f, 1f);
            if (this.attackStatus == 17 && this.boss.squaredDistanceTo(target) < 128D) {
                for (Entity entity : boss.method_48926().getOtherEntities(this.boss, new Box(targetPos).expand(1))) {
                    if (entity instanceof LivingEntity) {
                        entity.damage(this.boss.method_48926().getDamageSources().mobAttack(boss), this.getModifiedDamage(50f));
                ...
                if (!boss.method_48926().isClient) {
                    ParticleHandler.particleOutburstMap(this.boss.method_48926(), 300, this.targetPos.getX(), this.height == 0 ? targetPos.getY() : this.height, this.targetPos.getZ(), ParticleEvents.SOUL_FLAME_SMALL_OUTBURST_MAP, 1f);
                }
            }
        }
    ...
    private void moonfallLogic(LivingEntity target) {
        ...
        if (attackStatus == 21) this.boss.method_48926().playSound(null, this.boss.getBlockPos(), SoundRegistry.KNIGHT_SWORD_SMASH_EVENT, SoundCategory.HOSTILE, 1f, 1f);
        if (attackStatus == 1) this.boss.method_48926().playSound(null, this.boss.getBlockPos(), SoundRegistry.KNIGHT_CHARGE_SWORD_EVENT, SoundCategory.HOSTILE, 1f, 1f);
        if (this.attackStatus > 26 && this.attackStatus < 40) {
            ...
            for (Entity entity : this.boss.method_48926().getOtherEntities(this.boss, new Box(spot.getX() - 1, spot.getY() - 1, spot.getZ() - 1, spot.getX() + 1, spot.getY() + 1, spot.getZ() + 1))) {
                if (entity instanceof LivingEntity) {
                    entity.damage(this.boss.method_48926().getDamageSources().mobAttack(boss), this.getModifiedDamage(30f));
                    entity.addVelocity(0, 1.0, 0);
                }
            }
            this.boss.method_48926().playSound(null, BlockPos.ofFloored(spot), SoundEvents.ENTITY_GENERIC_EXPLODE, SoundCategory.HOSTILE, 1f, 1f);
            if (!this.boss.method_48926().isClient) {
                ParticleHandler.particleOutburstMap(this.boss.method_48926(), 300, spot.getX(), spot.getY(), spot.getZ(), ParticleEvents.SOUL_FLAME_RUPTURE_MAP, 1f);
            }
    ...
    private void moonveilLogic() {
        ...
        if (this.attackStatus == 29 || this.attackStatus == 42) {
            this.boss.method_48926().playSound(null, this.boss.getBlockPos(), SoundEvents.ENTITY_GENERIC_EXPLODE, SoundCategory.HOSTILE, 1f, 1f);
            for (Entity entity : this.boss.method_48926().getOtherEntities(boss, this.boss.getBoundingBox().expand(3))) {
                if (entity instanceof LivingEntity livingEntity) {
                    ...
                    livingEntity.damage(this.boss.method_48926().getDamageSources().mobAttack(this.boss), this.getModifiedDamage(50f));
                }
            }
            if (!boss.method_48926().isClient) {
                ParticleHandler.particleSphereList(this.boss.method_48926(), 1000, this.boss.getX(), this.boss.getY(), this.boss.getZ(), 1f, ParticleTypes.SOUL_FIRE_FLAME, ParticleTypes.LARGE_SMOKE);
            }
        }
    ...
    private void smashGround(float damage, SoundEvent sound, boolean isSoundDelayed) {
        for (Entity entity : this.boss.method_48926().getOtherEntities(this.boss, new Box(this.targetPos).expand(3))) {
            if (entity instanceof LivingEntity living) {
                entity.damage(CustomDamageSource.create(this.boss.method_48926(), CustomDamageSource.OBLITERATED, this.boss), this.getModifiedDamage(damage));
        ...
        if (!isSoundDelayed) this.boss.method_48926().playSound(null, this.targetPos, sound, SoundCategory.HOSTILE, 1f, 1f);
        if (!this.boss.method_48926().isClient) {
            ParticleHandler.particleOutburstMap(this.boss.method_48926(), 300, this.targetPos.getX(), this.targetPos.getY(), this.targetPos.getZ(), ParticleEvents.OBLITERATE_MAP, 1f);
        }
    }

    private void summonRemnant(Vec3d pos) {
        Remnant entity = new Remnant(EntityRegistry.REMNANT, this.boss.method_48926());
        if (this.canSummon()) entity.setPos(pos.getX(), pos.getY() + .1f, pos.getZ());
        this.initEquip(entity);
        this.boss.method_48926().playSound(null, entity.getBlockPos(), SoundRegistry.NIGHTFALL_SPAWN_EVENT, SoundCategory.HOSTILE, 1f, 1f);
        this.boss.method_48926().spawnEntity(entity);
        if (!this.boss.method_48926().isClient) {
            ParticleHandler.particleOutburstMap(this.boss.method_48926(), 100, pos.getX(), pos.getY(), pos.getZ(), ParticleEvents.SOUL_RUPTURE_MAP, 1f);
        }
    }
    ...
    private void maceOfSpadesLogic(LivingEntity target) {
        ...
        if (this.attackStatus < 3 && target.getBlockPos() != null) {
            ...
            if (this.attackStatus == 7) {
                for (Entity entity : this.boss.method_48926().getOtherEntities(this.boss, new Box(targetPos.getX() - 5, targetPos.getY() - 2, targetPos.getZ() - 5, targetPos.getX() + 5, targetPos.getY() + 2, targetPos.getZ() + 5))) {
                    if (entity instanceof LivingEntity livingEntity) {
                        livingEntity.takeKnockback(2f, -(livingEntity.getX() - this.boss.getX()), -(livingEntity.getZ() - this.boss.getZ()));
                        livingEntity.damage(this.boss.method_48926().getDamageSources().mobAttack(this.boss), this.getModifiedDamage(20f));
                    }
                }
                this.boss.method_48926().playSound(null, this.targetPos, SoundRegistry.KNIGHT_SWIPE_EVENT, SoundCategory.HOSTILE, 1f, 1f);
            }
            if (this.attackStatus == 13 && target.getBlockPos() != null) {
                this.targetPos = target.getBlockPos();
            }
            if (this.attackStatus == 21 && this.targetPos != null) {
                for (Entity entity : this.boss.method_48926().getOtherEntities(this.boss, new Box(this.targetPos).expand(3D))) {
                    if (entity instanceof LivingEntity livingEntity) {
                        livingEntity.addVelocity(0, 1, 0);
                        livingEntity.damage(this.boss.method_48926().getDamageSources().mobAttack(this.boss), this.getModifiedDamage(25f));
                    }
                }
                this.boss.method_48926().playSound(null, this.targetPos, SoundRegistry.NIGHTFALL_BONK_EVENT, SoundCategory.HOSTILE, 1f, 1f);
                if (!this.boss.method_48926().isClient) {
                    ParticleHandler.particleOutburstMap(this.boss.method_48926(), 300, this.targetPos.getX(), this.targetPos.getY(), this.targetPos.getZ(), ParticleEvents.OBLITERATE_MAP, 1f);
                }
            }
    ...
    private void ruptureLogic() {
        ...
        if (attackStatus == 21 || attackStatus == 33) {
            for (Entity entity : this.boss.method_48926().getOtherEntities(this.boss, this.boss.getBoundingBox().expand(12))) {
                this.boss.method_48926().playSound(null, entity.getBlockPos(), SoundEvents.ENTITY_ZOMBIE_ATTACK_WOODEN_DOOR, SoundCategory.HOSTILE, 1f, 1f);
            }
        }
        if (this.attackStatus == 52) {
            for (Entity entity : this.boss.method_48926().getOtherEntities(this.boss, this.boss.getBoundingBox().expand(12))) {
                if (entity instanceof LivingEntity && !(entity instanceof Remnant remnant && remnant.isOwner(this.boss))) {
                    entity.damage(this.boss.method_48926().getDamageSources().mobAttack(boss), this.getModifiedDamage(35f));
                    this.boss.method_48926().playSound(null, entity.getBlockPos(), SoundEvents.ENTITY_GENERIC_EXPLODE, SoundCategory.HOSTILE, 1f, 1f);
                    entity.addVelocity(0, 1.0, 0);
                    if (!this.boss.method_48926().isClient) {
                        ParticleHandler.particleOutburstMap(this.boss.method_48926(), 300, entity.getX(), entity.getY(), entity.getZ(), ParticleEvents.GROUND_RUPTURE_MAP, 1f);
                    }
                }
            }
        }
    ...
    private void blindingLightLogic() {
        ...
        if (this.attackStatus == 9) {
            if (!this.boss.method_48926().isClient) {
                ParticleHandler.particleOutburstMap(this.boss.method_48926(), 300, this.boss.getX(), this.boss.getY(), this.boss.getZ(), ParticleEvents.BLINDING_LIGHT_SMASH_MAP, 1f);
            }
            this.boss.method_48926().playSound(null, this.boss.getBlockPos(), SoundRegistry.BLINDING_LIGHT_EXPLOSION_EVENT, SoundCategory.HOSTILE, 1f, 1f);
            for (Entity entity : this.boss.method_48926().getOtherEntities(this.boss, this.boss.getBoundingBox().expand(3))) {
                if (entity instanceof LivingEntity living) {
                    living.damage(this.boss.method_48926().getDamageSources().mobAttack(this.boss), this.getModifiedDamage(20f));
            ...
            if (this.boss.isPhaseTwo()) {
                ...
                for (int theta = 0; theta < 360; theta+= 15) {
                    ...
                    MoonlightProjectile projectile = new MoonlightProjectile(EntityRegistry.MOONLIGHT_ENTITY_TYPE, this.boss.method_48926());
    ...
    private void summonLogic(LivingEntity target) {
        ...
        if (this.attackStatus == 30) {
            ...
            if (!this.boss.method_48926().isClient) {
                ParticleHandler.particleOutburstMap(this.boss.method_48926(), 300, target.getX(), target.getY(), target.getZ(), ParticleEvents.GROUND_RUPTURE_MAP, 1f);
            }
            target.addStatusEffect(new StatusEffectInstance(StatusEffects.SLOWNESS, 140, 1));
            this.boss.method_48926().playSound(null, target.getBlockPos(), SoundRegistry.NIGHTFALL_SPAWN_EVENT, SoundCategory.HOSTILE, 0.7f, 1f);
        }
    ...
    public boolean canSummon() {
        if (!this.boss.method_48926().getBlockState(this.pos).isAir()) {
