    ...
    public void tick() {
        ...
        if (target != null && !this.boss.getSpawning()) {
            ...
            if (this.boss.getHealth() <= this.boss.getMaxHealth() / 2.0F && !this.hasUsedUnbreakable && this.attackCooldown > 20) {
                ...
                this.boss.method_48926().playSound(null, this.boss.getBlockPos(), SoundRegistry.NIGHTFALL_SHIELD_EVENT, SoundCategory.HOSTILE, .75f, 1f);
            }
                ...
                if (this.attackStatus == 30) { //58,4 ticks
                    ...
                    for (int j = 0; j < enemyNumber; j++) {
                        ...
                        if (!this.boss.method_48926().isClient) {
                            ParticleHandler.particleOutburstMap(this.boss.method_48926(), 100, this.pos.getX(), this.pos.getY(), this.pos.getZ(), ParticleEvents.SOUL_RUPTURE_MAP, 1f);
                        }
                    }
                    for (int j = 0; j < healerNumber; j++) {
                        DarkSorcerer entity = new DarkSorcerer(EntityRegistry.DARK_SORCERER, this.boss.method_48926());
                        this.pos = new BlockPos(this.boss.getBlockX() + this.boss.getRandom().nextInt(32) - 16, this.boss.getBlockY() - 3, this.boss.getBlockZ() + this.boss.getRandom().nextInt(32) - 16);
            ...
            if (this.boss.getMaceOfSpades() && this.targetPos != null) {
                ...
                List<Entity> entities = this.boss.method_48926().getOtherEntities(this.boss, aoe);
                ...
                if (this.attackStatus == 21 && this.targetPos != null) {
                    entities = this.boss.method_48926().getOtherEntities(this.boss, new Box(this.targetPos).expand(3D));
                    for (Entity entity : entities) {
                        if (entity instanceof LivingEntity livingEntity) {
                ...
                if (this.attackStatus == 18) { //23
                    for (Entity entity : entities) {
                        if (entity instanceof LivingEntity living) {
                            entity.damage(CustomDamageSource.create(this.boss.method_48926(), CustomDamageSource.OBLITERATED, this.boss), this.getModifiedDamage(60f));
            ...
            if (this.boss.getBlind()) { //22,6 ticks
                ...
                if (attackStatus == 12 && distanceToEntity < 25f) {
                    target.damage(this.boss.method_48926().getDamageSources().mobAttack(this.boss), this.getModifiedDamage(10f));
                    ...
                    this.boss.method_48926().playSound(null, target.getBlockPos(), SoundEvents.BLOCK_AMETHYST_BLOCK_FALL, SoundCategory.HOSTILE, 1f, 1f);
                    if (!this.boss.method_48926().isClient) {
                        ParticleHandler.particleOutburstMap(this.boss.method_48926(), 150, target.getX(), target.getEyeY(), target.getZ(), ParticleEvents.BLINDING_LIGHT_MAP, 1f);
                    }
                }
                ...
                if (this.attackStatus == 52) {
                    for (Entity entity : entities) {
                        if (entity instanceof LivingEntity) {
                            entity.damage(this.boss.method_48926().getDamageSources().mobAttack(this.boss), this.getModifiedDamage(30f));
