...
public class ConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreFeatureConfig.Target> overworldMoonstoneOres = List.of(
                OreFeatureConfig.createTarget(stoneReplaceables, BlockRegistry.MOONSTONE_ORE.get().getDefaultState()),
                OreFeatureConfig.createTarget(deepslateReplaceables, BlockRegistry.MOONSTONE_ORE_DEEPSLATE.get().getDefaultState())
        );
        List<OreFeatureConfig.Target> overworldVerglasOres = List.of(
                OreFeatureConfig.createTarget(stoneReplaceables, BlockRegistry.VERGLAS_ORE.get().getDefaultState()),
