...
public interface IHasAbilities extends IConfigDisable {
    ...
    /**
     * @return true if any ability is charge to use, meaning it will need the {@link Item#onStoppedUsing(ItemStack, World, LivingEntity, int)}
     * call. This will make the item skip all calls from the {@link Item#use(World, PlayerEntity, Hand)} method for abilities.
     * <p>
    ...
    /**
     * Mainly used in {@link RangedWeaponItem} items.
