...
public class SoulIngotArmor extends ModdedArmor {
    ...
    public SoulIngotArmor(ArmorMaterial material, EquipmentType type, Settings settings) {
        super(material, type, settings, applyCustomAttributeAbilities(
                ConfigConstructor.soul_ingot_posture_buildup_resistances,
                ConfigConstructor.soul_ingot_base_posture_increase,
                ConfigConstructor.soul_ingot_bleed_buildup_resistances,
                ConfigConstructor.soul_ingot_bleed_damage_resistances
        ));
