...
public class Hallowheart extends ModdedArmor implements GeoItem {
    ...
    public Hallowheart(ArmorMaterial material, EquipmentType type, Settings settings) {
        super(material, type, settings, applyCustomAttributeAbilities(
                ConfigConstructor.withered_armor_posture_buildup_resistances,
                ConfigConstructor.withered_armor_base_posture_increase,
                ConfigConstructor.withered_armor_bleed_buildup_resistances,
                ConfigConstructor.withered_armor_bleed_damage_resistances
        ));
