...
public class WitheredArmor extends ModdedGeoArmor implements IAnimatable, IKeybindAbility, ICooldownItem {
    ...
    private boolean isChestActive(PlayerEntity player) {
        ...
        return !chest.isEmpty() && !this.isDisabled(chest) && (chest.isOf(ItemRegistry.WITHERED_CHEST.get()) || chest.isOf(ItemRegistry.ENHANCED_WITHERED_CHEST.get()));
    }
    ...
    public boolean canEnchantReduceCooldown(ItemStack stack) {
        return (stack.isOf(ItemRegistry.WITHERED_CHEST.get()) || stack.isOf(ItemRegistry.ENHANCED_WITHERED_CHEST.get())) && ConfigConstructor.withered_chest_ability_enchant_reduces_cooldown;
    }
