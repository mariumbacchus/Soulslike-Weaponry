...
public class UmbralTrespassItem extends SoulHarvestingItem {
    ...
    private int ticksBeforeDismount;
        ...
        if (user.getAttacking() != null && user.squaredDistanceTo(user.getAttacking()) < 200D) {
            ...
            if (user.startRiding(target, true)) {
                ...
                if (!world.isClient) {
                    ...
                    ParticleNetworking.specificServerParticlePacket((ServerWorld) world, PacketRegistry.UMBRAL_TRESPASS_ID, user.getBlockPos(), user.getEyeY());
                }
