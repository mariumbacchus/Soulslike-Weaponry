...
public class CustomPotionItem extends PotionItem {
    ...
    public CustomPotionItem(Settings settings, RegistryObject<Potion> potion) {
        super(settings);
        this.potion = potion;
    }

    public List<StatusEffectInstance> getEffects() {
        return this.potion.get().getEffects();
    }
    ...
    public ActionResult useOnEntity(ItemStack stack, PlayerEntity user, LivingEntity entity, Hand hand) {
        ItemStack itemStack = user.getStackInHand(hand);
        if (entity.hasStatusEffect(EffectRegistry.CHUNGUS_TONIC_EFFECT.get()) || !this.canUse(stack)) {
