...
public class BossCompassPredicate {
    ...
    public static void init() {
        ...
        ModelPredicateProviderRegistry.register(ItemRegistry.BOSS_COMPASS.get(), new Identifier("angle"), new UnclampedModelPredicateProvider(){
            ...
            public float unclampedCall(ItemStack itemStack, @Nullable ClientWorld clientWorld, @Nullable LivingEntity livingEntity, int i) {
                ...
                if (itemStack.getItem() == ItemRegistry.BOSS_COMPASS.get()) blockPos = ((BossCompass)itemStack.getItem()).getStructurePos(itemStack);
