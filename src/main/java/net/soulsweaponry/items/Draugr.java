...
public class Draugr extends SwordItem {
    ...
    public Multimap<EntityAttribute, EntityAttributeModifier> getAttributeModifiers(EquipmentSlot slot, ItemStack stack) {
        ...
        if (slot == EquipmentSlot.MAINHAND) {
            ...
            builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(ATTACK_DAMAGE_MODIFIER_ID, "Weapon modifier", this.isNight(stack) ? CommonConfig.DRAUGR_NIGHT_DAMAGE.get() - 1 : 0, EntityAttributeModifier.Operation.ADDITION));
