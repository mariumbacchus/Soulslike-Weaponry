...
public class WitheredWabbajack extends ModdedSword {
    ...
    public static void initProjectileList() {
        WitheredWabbajack.PROJECTILES.add(new LuckChosenObject<>(EntityType.ARROW, WeaponUtil.LuckType.BAD));
        WitheredWabbajack.PROJECTILES.add(new LuckChosenObject<>(EntityType.EGG, WeaponUtil.LuckType.BAD));
        WitheredWabbajack.PROJECTILES.add(new LuckChosenObject<>(EntityType.ENDER_PEARL, WeaponUtil.LuckType.BAD));
        WitheredWabbajack.PROJECTILES.add(new LuckChosenObject<>(EntityType.EXPERIENCE_BOTTLE, WeaponUtil.LuckType.BAD));
        WitheredWabbajack.PROJECTILES.add(new LuckChosenObject<>(EntityType.SMALL_FIREBALL, WeaponUtil.LuckType.BAD));
        WitheredWabbajack.PROJECTILES.add(new LuckChosenObject<>(EntityType.SNOWBALL, WeaponUtil.LuckType.BAD));
        WitheredWabbajack.PROJECTILES.add(new LuckChosenObject<>(EntityType.WITHER_SKULL, WeaponUtil.LuckType.BAD));
        WitheredWabbajack.PROJECTILES.add(new LuckChosenObject<>(EntityType.FIREBALL, WeaponUtil.LuckType.NEUTRAL));
        WitheredWabbajack.PROJECTILES.add(new LuckChosenObject<>(EntityRegistry.GROWING_FIREBALL_ENTITY.get(), WeaponUtil.LuckType.NEUTRAL));
        WitheredWabbajack.PROJECTILES.add(new LuckChosenObject<>(EntityRegistry.DRAGON_STAFF_PROJECTILE.get(), WeaponUtil.LuckType.NEUTRAL));
        WitheredWabbajack.PROJECTILES.add(new LuckChosenObject<>(EntityRegistry.WITHERED_WABBAJACK_PROJECTILE.get(), WeaponUtil.LuckType.GOOD));
    }
