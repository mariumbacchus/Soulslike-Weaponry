...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    ENHANCED_CHAOS_ARMOR("enhanced_chaos_armor", new int[]{500, 600, 700, 500}, ConfigConstructor.enhanced_chaos_armor_armor_points, 15, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 4.0f, 0.2f, Ingredient.ofItems(ItemRegistry.MOONSTONE, Items.NETHERITE_INGOT)),
    ...
    ENHANCED_WITHERED_ARMOR("enhanced_withered_armor", new int[]{500, 600, 700, 500}, ConfigConstructor.enhanced_withered_armor_armor_points, 15, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 4.0f, 0.2f, Ingredient.ofItems(ItemRegistry.CRIMSON_INGOT, Items.NETHERITE_INGOT));
