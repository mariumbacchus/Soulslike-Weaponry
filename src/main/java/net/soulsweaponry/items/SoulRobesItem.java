...
public class SoulRobesItem  extends ArmorItem {
    ...
    private boolean hasFullSet(PlayerEntity player) {
        ...
        boolean bootsSlot = !boots.isEmpty() && boots.getItem() == ArmorRegistry.SOUL_ROBES_BOOTS;
        boolean leggingsSlot = !leggings.isEmpty() && leggings.getItem() == ArmorRegistry.SOUL_ROBES_LEGGINGS;
        boolean chestSlot = !chestplate.isEmpty() && chestplate.getItem() == ArmorRegistry.SOUL_ROBES_CHESTPLATE;
        boolean helmetSlot = !helmet.isEmpty() && helmet.getItem() == ArmorRegistry.SOUL_ROBES_HELMET;
