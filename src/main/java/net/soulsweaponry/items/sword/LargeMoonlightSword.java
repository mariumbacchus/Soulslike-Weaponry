...
public class LargeMoonlightSword extends ModdedSword implements GeoItem {
    ...
    private static final UndeadBonus UNDEAD_BONUS = new UndeadBonus(
            WeaponConfig.large_sword_of_moonlight_righteous_base_undead_bonus_damage,
            WeaponConfig.large_sword_of_moonlight_righteous_undead_bonus_damage_per_level
    );
    private static final Block BLOCK = new Block(WeaponConfig.large_sword_of_moonlight_magic_damage_reduction_when_blocking);
    private static final ApplyMagicFrailty APPLY_MAGIC_FRAILTY = new ApplyMagicFrailty(
            (int) WeaponConfig.large_sword_of_moonlight_magic_frailty_duration,
            WeaponConfig.large_sword_of_moonlight_magic_frailty_duration_per_level,
            (int) WeaponConfig.large_sword_of_moonlight_magic_frailty_amp,
            WeaponConfig.large_sword_of_moonlight_magic_frailty_amp_per_level
    );

    public LargeMoonlightSword(ToolMaterial toolMaterial, Settings settings) {
        super(toolMaterial, (int) WeaponConfig.large_sword_of_moonlight_damage, WeaponConfig.large_sword_of_moonlight_attack_speed, settings);
        this.addAbility(MOONLIT, APPLY_MAGIC_FRAILTY, UNDEAD_BONUS, BLOCK);
    }

    @Override
    public boolean isDisabled(ItemStack stack) {
        return WeaponConfig.disable_use_large_sword_of_moonlight;
    }
