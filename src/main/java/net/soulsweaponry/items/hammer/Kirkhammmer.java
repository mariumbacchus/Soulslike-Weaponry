...
public class Kirkhammmer extends TrickWeapon {
    ...
    private static final DetonateGroundAttributes ATTRIBUTES = new DetonateGroundAttributes(
            ...
            Map.of(ParticleRegistry.BLACK_FLAME.get(), new Vec3d(1, 6, 1)),
    ...
    public Kirkhammmer(ToolMaterial toolMaterial, Settings settings) {
        super(toolMaterial, (int) ConfigConstructor.kirkhammer_damage, ConfigConstructor.kirkhammer_attack_speed, settings, ConfigConstructor.is_fireproof_kirkhammer, ConfigConstructor.disable_use_kirkhammer);
