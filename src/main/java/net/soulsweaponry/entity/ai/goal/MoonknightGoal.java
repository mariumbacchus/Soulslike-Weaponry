...
public class MoonknightGoal extends Goal {
    ...
    private void coreBeam(LivingEntity target) {
        ...
        if (this.targetPos != null) {
            ...
            if (this.attackStatus >= 21 && this.attackStatus <= 47) {
                if (attackStatus == 21) this.boss.getWorld().playSound(null, targetPos, SoundRegistry.KNIGHT_CORE_BEAM_EVENT, SoundCategory.HOSTILE, 1f, 1f);
    ...
    private void swordOfLight(LivingEntity target) {
        ...
        if (this.targetPos != null && target.getPos() != null) {
            ...
            switch (attackStatus) {
                ...
                case 39 -> this.boss.getWorld().playSound(null, this.targetPos, SoundRegistry.KNIGHT_SWORD_SMASH_EVENT, SoundCategory.HOSTILE, 1f, 1f);
                case 43 -> {
    ...
    private void thrustLogic(LivingEntity target) {
        ...
        if (this.attackStatus < 13 && target.getBlockPos() != null) {
            ...
            this.boss.getNavigation().startMovingTo(this.targetPos.getX(), this.targetPos.getY(), this.targetPos.getZ(), 0.0D);
            switch (attackStatus) {
                case 15 -> this.boss.getWorld().playSound(null, targetPos, SoundRegistry.KNIGHT_THRUST_SWORD_EVENT, SoundCategory.HOSTILE, 1f, 1f);
                case 17 -> {
                ...
                case 39 -> {
                    ...
                    this.boss.getWorld().playSound(null, this.targetPos, SoundRegistry.SCYTHE_SWIPE, SoundCategory.HOSTILE, 1f, 1f);
                }
            }
        }
