...
public class MoonknightGoal extends Goal {
    ...
    private void heavySwing(LivingEntity target) {
        ...
        if (this.attackStatus == 21) {
            ...
            MoonlightProjectile projectile = new MoonlightProjectile(EntityRegistry.HORIZONTAL_MOONLIGHT_ENTITY_TYPE, this.boss.getWorld(), this.boss);
    ...
    private void swordOfLight(LivingEntity target) {
        ...
        if (this.targetPos != null && target.getPos() != null) {
            ...
            if (attackStatus == 31) this.boss.getWorld().playSound(null, this.targetPos, SoundRegistry.KNIGHT_SWORD_SMASH_EVENT, SoundCategory.HOSTILE, 1f, 1f);
            if (attackStatus == 35) {
