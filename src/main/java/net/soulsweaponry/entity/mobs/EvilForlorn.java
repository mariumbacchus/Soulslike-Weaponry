...
public class EvilForlorn extends Forlorn {
    ...
    public static DefaultAttributeContainer.Builder createForlornAttributes() {
        ...
        .add(EntityAttributes.FOLLOW_RANGE, 250D)
        .add(EntityAttributes.MAX_HEALTH, BossConfig.evil_forlorn_health)
        .add(EntityAttributes.ARMOR, BossConfig.evil_forlorn_bonus_armor)
