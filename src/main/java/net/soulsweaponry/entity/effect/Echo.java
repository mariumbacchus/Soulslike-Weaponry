...
public class Echo extends StatusEffect {
    ...
    public void applyUpdateEffect(LivingEntity entity, int amplifier) {
        ...
        if (!entity.getWorld().isClient) {
            ParticleHandler.particleOutburst(entity.getWorld(), 20, entity.getParticleX(0.5f), entity.getBodyY(0.5f), entity.getParticleZ(0.5f), ParticleRegistry.ECHO_SMOKE.get(), new Vec3d(1, 1, 1), 0.5f);
            ParticleHandler.singleParticle(entity.getWorld(), ParticleRegistry.ECHO_SWEEP_ATTACK.get(), entity.getParticleX(0.5f), entity.getBodyY(0.5f), entity.getParticleZ(0.5f), 0, 0, 0);
            ParticleHandler.singleParticle(entity.getWorld(), ParticleRegistry.ECHO_SWEEP_ATTACK.get(), entity.getParticleX(0.5f), entity.getBodyY(0.5f), entity.getParticleZ(0.5f), 0, 0, 0);
        }
    }
