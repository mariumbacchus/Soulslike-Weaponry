...
public class MoltenMetal extends NoClipEntity implements GeoEntity {
    ...
    public MoltenMetal(World world, float width, float height) {
        super(EntityRegistry.MOLTEN_METAL.get(), world);
    ...
    public void tick() {
        ...
        for (LivingEntity livingEntity : list) {
            ...
            if (livingEntity instanceof PlayerEntity player && stack.isIn(Tags.Items.TOOLS_SHIELDS) && !player.getItemCooldownManager().isCoolingDown(stack.getItem())) {
