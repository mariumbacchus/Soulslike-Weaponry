    ...
    static {
        EVENTS.put(SPAWN_FIRE, (entity, otherAttributes) -> {
            ...
            if (entity.getParticleAmountMod() > 0) {
                Map<ParticleEffect, Vec3d> map = Map.of(ParticleTypes.WAX_ON, entity.getParticleVec(), ParticleTypes.FLAME, entity.getParticleVec(), ParticleRegistry.SUN_PARTICLE, entity.getParticleVec());
