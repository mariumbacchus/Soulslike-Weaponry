...
public class WitheredArmorModel<T extends Item & GeoItem> extends GeoModel<T> {
    ...
    @Override
    public Identifier getModelResource(T object, @Nullable GeoRenderer<T> geoRenderer) {
        return Identifier.of(SoulsWeaponry.ModId, "geo/withered_armor.geo.json");
    }

    @Override
    public Identifier getTextureResource(T object, @Nullable GeoRenderer<T> geoRenderer) {
