...
public class AccursedLordBossModel extends AnimatedGeoModel<AccursedLordBoss>{
    ...
    @Override
    public Identifier getModelLocation(AccursedLordBoss object)
    {
        return new Identifier(SoulsWeaponry.ModId, "geo/accursed_lord.geo.json");
    }

    @Override
    public Identifier getTextureLocation(AccursedLordBoss object)
    {
        return new Identifier(SoulsWeaponry.ModId, "textures/entity/accursed_lord_texture.png");
    }

    @Override
    public Identifier getAnimationFileLocation(AccursedLordBoss object)
    {
    ...
    @Override
    public void setCustomAnimations(AccursedLordBoss animatable, int instanceId, AnimationEvent customPredicate) {
