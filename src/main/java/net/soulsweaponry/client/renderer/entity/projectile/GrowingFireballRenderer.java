...
public class GrowingFireballRenderer extends GeoProjectilesRenderer<GrowingFireball> {
    ...
    @Override
    public RenderLayer getRenderType(GrowingFireball animatable, float partialTick, MatrixStack poseStack, @Nullable VertexConsumerProvider bufferSource, @Nullable VertexConsumer buffer, int packedLight, Identifier texture) {
