...
import net.soulsweaponry.client.model.entity.projectile.DragonwoundWaveModel;
import net.soulsweaponry.entity.projectile.noclip.MoonveilWave;
import software.bernie.geckolib.cache.object.BakedGeoModel;

public class DragonwoundWaveRenderer extends GeoProjectileRenderer<MoonveilWave> {

    public DragonwoundWaveRenderer(EntityRendererFactory.Context renderManager) {
        super(renderManager, new DragonwoundWaveModel());
    }
