...
public class SoulReaperGhostRenderer extends MobEntityRenderer<SoulReaperGhost, SoulReaperGhostRenderer.SoulReaperGhostRenderState, SoulReaperGhostModel> {
    ...
    public SoulReaperGhostRenderer(EntityRendererFactory.Context ctx) {
        ...
        BipedEntityModel<SoulReaperGhostRenderState> innerArmor =
                new BipedEntityModel<>(ctx.getPart(EntityModelLayerModRegistry.SOUL_REAPER_GHOST_INNER_ARMOR));
        BipedEntityModel<SoulReaperGhostRenderState> outerArmor =
                new BipedEntityModel<>(ctx.getPart(EntityModelLayerModRegistry.SOUL_REAPER_GHOST_OUTER_ARMOR));
