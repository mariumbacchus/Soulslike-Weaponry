...
public class TargetPostureHudOverlay implements HudRenderCallback {
    ...
    private static final Identifier TEXTURE =
            Identifier.of(SoulsWeaponry.ModId, "textures/gui/posture_bars_target.png");

    @Override
    public void onHudRender(DrawContext drawContext, RenderTickCounter renderTickCounter) {
        MinecraftClient client = MinecraftClient.getInstance();
        if (client == null || ClientConfig.disable_target_posture_hud) return;
        ...
        float posturePerPixel = TargetPostureData.getTargetsMaxPosture(client.player) / 182.0F;
