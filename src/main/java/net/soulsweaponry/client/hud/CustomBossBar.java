...
public record CustomBossBar(EntityType<?> entityType, Identifier emptyBar, Identifier filledBar) {
    ...
    public static void init() {
        ...
        //CUSTOM_BOSS_BARS.add(new CustomBossBar(EntityRegistry.RETURNING_KNIGHT.get(), new Identifier(SoulsWeaponry.ModId, "textures/gui/posture/empty.png"), new Identifier(SoulsWeaponry.ModId, "textures/gui/posture/full.png")));
    }
}