...
public class EntityModelRegistry {
    ...
    public static void initClient() {
        ...
        EntityRendererRegistry.register(EntityRegistry.HORIZONTAL_MOONLIGHT_ENTITY_TYPE, (ctx) -> new MoonlightProjectileRenderer(ctx, new VerticalMoonlightProjectileModel()));
        ...
        EntityRendererRegistry.register(EntityRegistry.FLAME_PILLAR, FlamePillarRenderer::new);
