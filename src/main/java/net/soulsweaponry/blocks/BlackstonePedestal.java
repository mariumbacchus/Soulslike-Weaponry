...
public class BlackstonePedestal extends Block {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (itemStack.isOf(ItemRegistry.SHARD_OF_UNCERTAINTY.get())) {
            ...
            ChaosMonarch boss = new ChaosMonarch(EntityRegistry.CHAOS_MONARCH.get(), world);
            ...
            AccursedLordBoss boss = new AccursedLordBoss(EntityRegistry.ACCURSED_LORD_BOSS.get(), world);
            boss.setPos(pos.getX(), pos.getY() + .1f, pos.getZ());
            boss.setAttackAnimation(AccursedLordBoss.AccursedLordAnimations.SPAWN);
            world.playSound(null, pos, SoundRegistry.NIGHTFALL_SPAWN_EVENT.get(), SoundCategory.HOSTILE, 1f, 1f);
            world.spawnEntity(boss);
            world.removeBlock(pos, false);
            return ActionResult.SUCCESS;
