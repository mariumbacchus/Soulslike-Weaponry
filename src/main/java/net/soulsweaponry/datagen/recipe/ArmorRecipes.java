...
public class ArmorRecipes {
    ...
    public static void generateRecipes(Consumer<RecipeJsonProvider> consumer) {
        ...
        if (!ConfigConstructor.disable_recipe_enhanced_arkenplate) {
            WeaponRecipeProvider.smithingRecipeCombat(Ingredient.ofItems(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE), Ingredient.ofItems(ItemRegistry.ARKENPLATE), Ingredient.ofItems(ItemRegistry.LORD_SOUL_NIGHT_PROWLER), ItemRegistry.ENHANCED_ARKENPLATE, ItemRegistry.LORD_SOUL_NIGHT_PROWLER, "infused_arkenplate", consumer);
        }
        if (!ConfigConstructor.disable_recipe_enhanced_withered_chest) {
            WeaponRecipeProvider.smithingRecipeCombat(Ingredient.ofItems(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE), Ingredient.ofItems(ItemRegistry.WITHERED_CHEST), Ingredient.ofItems(ItemRegistry.LORD_SOUL_DAY_STALKER), ItemRegistry.ENHANCED_WITHERED_CHEST, ItemRegistry.LORD_SOUL_DAY_STALKER, "infused_withered_chest", consumer);
        }
    }
}