...
public class WeaponRecipes {
    ...
    public static void generateRecipes(RecipeExporter exporter) {
        ...
        if (!ConfigConstructor.disable_recipe_darkin_blade) {
            WeaponRecipeProvider.smithingRecipeLordSoulCombat(Ingredient.ofItems(WeaponRegistry.BLOODTHIRSTER), WeaponRegistry.DARKIN_BLADE, "darkin_blade", exporter);
        }
        if (!ConfigConstructor.disable_recipe_dawnbreaker) {
            WeaponRecipeProvider.smithingRecipeLordSoulCombat(Ingredient.ofItems(Items.GOLDEN_SWORD), WeaponRegistry.DAWNBREAKER, "dawnbreaker", exporter);
        }
        ...
        if (!ConfigConstructor.disable_recipe_moonlight_greatsword) {
            WeaponRecipeProvider.smithingRecipeLordSoulCombat(Ingredient.ofItems(WeaponRegistry.BLUEMOON_GREATSWORD), WeaponRegistry.MOONLIGHT_GREATSWORD, "moonlight_greatsword", exporter);
        }
        if (!ConfigConstructor.disable_recipe_moonlight_shortsword) {
            WeaponRecipeProvider.smithingRecipeLordSoulCombat(Ingredient.ofItems(WeaponRegistry.BLUEMOON_SHORTSWORD), WeaponRegistry.MOONLIGHT_SHORTSWORD, "moonlight_shortsword", exporter);
        }
        ...
        if (!ConfigConstructor.disable_recipe_draugr) {
            WeaponRecipeProvider.smithingRecipeCombat(Ingredient.ofItems(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE), Ingredient.ofItems(Items.IRON_SWORD), Ingredient.ofItems(ItemRegistry.ESSENCE_OF_EVENTIDE), WeaponRegistry.DRAUGR, ItemRegistry.ESSENCE_OF_EVENTIDE, "draugr", exporter);
        }
        ...
        if (!ConfigConstructor.disable_recipe_crucible_sword) {
            WeaponRecipeProvider.smithingRecipeLordSoulCombat(Ingredient.ofItems(Items.NETHERITE_SWORD), WeaponRegistry.CRUCIBLE_SWORD, "crucible_sword", exporter);
        }
        ...
        if (!ConfigConstructor.disable_recipe_holy_moonlight_sword) {
            WeaponRecipeProvider.smithingRecipeLordSoulCombat(Ingredient.ofItems(WeaponRegistry.STING), WeaponRegistry.HOLY_MOONLIGHT_SWORD, "holy_moonlight_sword", exporter);
        }
        if (!ConfigConstructor.disable_recipe_master_sword) {
            WeaponRecipeProvider.smithingRecipeLordSoulCombat(Ingredient.ofItems(Items.DIAMOND_SWORD), WeaponRegistry.MASTER_SWORD, "master_sword", exporter);
        }
        ...
        if (!ConfigConstructor.disable_recipe_empowered_dawnbreaker) {
            WeaponRecipeProvider.smithingRecipeCombat(Ingredient.ofItems(Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE), Ingredient.ofItems(WeaponRegistry.DAWNBREAKER), Ingredient.ofItems(ItemRegistry.LORD_SOUL_DAY_STALKER), WeaponRegistry.EMPOWERED_DAWNBREAKER, ItemRegistry.LORD_SOUL_DAY_STALKER, "emp_dawnbreaker", exporter);
        }
