...
public class EntityTagsProvider extends FabricTagProvider.EntityTypeTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        ...
        this.getOrCreateTagBuilder(ModTags.Entities.UNDEAD)
                ...
                .add(EntityRegistry.NIGHT_SHADE)
                .add(EntityRegistry.RETURNING_KNIGHT)
                .add(EntityRegistry.REMNANT)
                .add(EntityRegistry.DARK_SORCERER)
                .add(EntityRegistry.SOUL_REAPER_GHOST)
                .add(EntityRegistry.FORLORN)
                .add(EntityRegistry.EVIL_FORLORN)
                .add(EntityRegistry.SOULMASS)
                .add(EntityRegistry.CHAOS_MONARCH)
