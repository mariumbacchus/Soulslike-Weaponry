...
public class ChestLootTableProvider implements LootTableGenerator {
    ...
    public void accept(BiConsumer<Identifier, LootTable.Builder> exporter) {
        ...
        LootPool.Builder pool = LootPool.builder()
                ...
                .with(ItemEntry.builder(ItemRegistry.LOST_SOUL.get()).weight(15)
                        .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1, 3))))
        ...
        LootPool.Builder p1 = LootPool.builder()
                ...
                .with(ItemEntry.builder(ItemRegistry.CHUNGUS_EMERALD.get()).weight(15))
        ...
        LootPool.Builder p2 = LootPool.builder()
                ...
                .with(ItemEntry.builder(ItemRegistry.LOST_SOUL.get()).weight(20)
                        .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1, 4))))
