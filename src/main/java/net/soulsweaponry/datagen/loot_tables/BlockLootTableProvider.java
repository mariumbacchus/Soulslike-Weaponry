...
public class BlockLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        addDrop(BlockRegistry.MOONSTONE_ORE,
                oreDrops(BlockRegistry.MOONSTONE_ORE, ItemRegistry.MOONSTONE));

        addDrop(BlockRegistry.MOONSTONE_ORE_DEEPSLATE,
                oreDrops(BlockRegistry.MOONSTONE_ORE_DEEPSLATE, ItemRegistry.MOONSTONE));

        addDrop(BlockRegistry.VERGLAS_ORE,
                oreDrops(BlockRegistry.VERGLAS_ORE, ItemRegistry.VERGLAS));

        addDrop(BlockRegistry.VERGLAS_ORE_DEEPSLATE,
                oreDrops(BlockRegistry.VERGLAS_ORE_DEEPSLATE, ItemRegistry.VERGLAS));
        ...
        addDrop(BlockRegistry.WITHERED_GRASS_BLOCK,
                drops(BlockRegistry.WITHERED_GRASS_BLOCK, BlockRegistry.WITHERED_DIRT));

        addDrop(BlockRegistry.OLEANDER,
                doorDrops(BlockRegistry.OLEANDER));
    }
}