...
public class ChungusBarterLootTables implements LootTableGenerator {
    ...
    public void accept(BiConsumer<Identifier, LootTable.Builder> exporter) {
        ...
        pool.with(it(ItemRegistry.LORD_SOUL_RED.get(), 3));
        ...
        // chungus drops
        pool.with(ItemEntry.builder(Items.POTION).weight(15).apply(SetPotionLootFunction.builder(EffectRegistry.CHUNGUS_TONIC_POTION.get())));
        pool.with(ItemEntry.builder(Items.SPLASH_POTION).weight(3).apply(SetPotionLootFunction.builder(EffectRegistry.CHUNGUS_TONIC_POTION.get())));
        pool.with(it(ItemRegistry.CHUNGUS_DISC.get(), 20));
        pool.with(it(BlockRegistry.CHUNGUS_MONOLITH.get(), 60));
        pool.with(ItemEntry.builder(ItemRegistry.CHUNGUS_EMERALD.get()).weight(100).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1, 10))));
        pool.with(it(WeaponRegistry.CHUNGUS_STAFF.get(), 20));
