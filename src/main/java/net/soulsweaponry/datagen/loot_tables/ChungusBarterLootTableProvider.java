...
public class ChungusBarterLootTableProvider extends SimpleFabricLootTableProvider {
    ...
    public ChungusBarterLootTableProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
    ...
    public void accept(BiConsumer<RegistryKey<LootTable>, LootTable.Builder> lootTableBiConsumer) {
        ...
        pool.with(ItemEntry.builder(Items.CARVED_PUMPKIN).weight(70)
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.BINDING_CURSE), ConstantLootNumberProvider.create(1))));
        pool.with(ItemEntry.builder(Items.BOOK).weight(50)
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.VANISHING_CURSE), ConstantLootNumberProvider.create(1))));
        pool.with(ItemEntry.builder(Items.BOOK).weight(50)
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.BINDING_CURSE), ConstantLootNumberProvider.create(1))));
        pool.with(ItemEntry.builder(Items.SPONGE).weight(60)
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.SWIFT_SNEAK), UniformLootNumberProvider.create(1.0F, 10f)))
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.SOUL_SPEED), UniformLootNumberProvider.create(1.0F, 10f)))
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.UNBREAKING), UniformLootNumberProvider.create(1.0F, 10f))));
        ...
        pool.with(ItemEntry.builder(Items.GOLDEN_HOE).weight(80)
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.LOYALTY), ConstantLootNumberProvider.create(3))));
        ...
        pool.with(ItemEntry.builder(Items.CHAINMAIL_BOOTS).weight(50)
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.AQUA_AFFINITY), UniformLootNumberProvider.create(1.0F, 10f))));
        ...
        pool.with(ItemEntry.builder(Items.END_ROD).weight(40)
                ...
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.PROTECTION), UniformLootNumberProvider.create(1.0F, 10f))));
        ...
        pool.with(ItemEntry.builder(Items.FLINT_AND_STEEL).weight(40)
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.FIRE_ASPECT), UniformLootNumberProvider.create(5.0F, 10f))));
        pool.with(ItemEntry.builder(Items.POISONOUS_POTATO).weight(80)
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.BANE_OF_ARTHROPODS), UniformLootNumberProvider.create(3.0F, 10f))));
        ...
        pool.with(ItemEntry.builder(Items.LEATHER_BOOTS).weight(50)
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.SWIFT_SNEAK), UniformLootNumberProvider.create(1.0F, 5f))));
        ...
        pool.with(ItemEntry.builder(Items.WOODEN_SWORD).weight(60)
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.FIRE_ASPECT), UniformLootNumberProvider.create(1.0F, 5f)))
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.SHARPNESS), UniformLootNumberProvider.create(1.0F, 8f)))
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.SWEEPING_EDGE), UniformLootNumberProvider.create(1.0F, 5f))));
        pool.with(ItemEntry.builder(Items.IRON_CHESTPLATE).weight(40)
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.BLAST_PROTECTION), UniformLootNumberProvider.create(1.0F, 6f)))
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.BINDING_CURSE), ConstantLootNumberProvider.create(1)))
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.FIRE_PROTECTION), UniformLootNumberProvider.create(1.0F, 6f)))
                .apply(new SetEnchantmentsLootFunction.Builder().enchantment(impl.getOrThrow(Enchantments.PROJECTILE_PROTECTION), UniformLootNumberProvider.create(1.0F, 6f))));
        ...
        lootTableBiConsumer.accept(key, LootTable.builder().pool(pool));
    }
