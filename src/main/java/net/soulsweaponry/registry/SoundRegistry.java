...
public class SoundRegistry {
    ...
    public static final RegistryObject<SoundEvent> STORMVEIL_AMBIENT = registerSound("stormveil_ambient");
    public static final RegistryObject<SoundEvent> STORMVEIL_TRIGGER = registerSound("stormveil_trigger");
    public static final RegistryObject<SoundEvent> STORMVEIL_THORNS = registerSound("stormveil_thorns");
    public static final RegistryObject<SoundEvent> BLOOD_LOSS = registerSound("blood_loss");
