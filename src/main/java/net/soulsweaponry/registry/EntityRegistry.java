...
public class EntityRegistry {
    ...
    public static final EntityType<Cannonball> CANNONBALL = Registry.register(Registry.ENTITY_TYPE, new Identifier(ModId, "cannonball_entity_type"), FabricEntityTypeBuilder.<Cannonball>create(SpawnGroup.MISC, Cannonball::new).dimensions(EntityDimensions.fixed(0.5F, 0.5F)).trackRangeBlocks(10).trackedUpdateRate(20).build());
