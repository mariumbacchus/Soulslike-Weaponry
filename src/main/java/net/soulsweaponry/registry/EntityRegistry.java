...
public class EntityRegistry {
    ...
    public static final RegistryObject<EntityType<Remnant>> REMNANT = registerWithSpawnEgg("remnant", () -> EntityType.Builder.create(Remnant::new, SpawnGroup.MONSTER).setDimensions(0.7f, 1.95F).build("remnant"), 6447971, 65514); // 0.6F, 1.95F (zombie hitbox)
    public static final RegistryObject<EntityType<DarkSorcerer>> DARK_SORCERER = registerWithSpawnEgg("dark_sorcerer", () -> EntityType.Builder.create(DarkSorcerer::new, SpawnGroup.MONSTER).setDimensions(0.7f, 1.95F).build("dark_sorcerer"), 0, 2572343);
    ...
    public static final RegistryObject<EntityType<SoulReaperGhost>> SOUL_REAPER_GHOST = registerWithSpawnEgg("soul_reaper_ghost", () -> EntityType.Builder.create(SoulReaperGhost::new, SpawnGroup.MONSTER).setDimensions(0.7f, 1.95F).build("soul_reaper_ghost"), 13480150, 13200614);
    public static final RegistryObject<EntityType<Forlorn>> FORLORN = registerWithSpawnEgg("forlorn", () -> EntityType.Builder.create(Forlorn::new, SpawnGroup.MONSTER).setDimensions(0.7f, 1.95F).build("forlorn"), 4859716, 5701896);
    public static final RegistryObject<EntityType<EvilForlorn>> EVIL_FORLORN = registerWithSpawnEgg("evil_forlorn", () -> EntityType.Builder.create(EvilForlorn::new, SpawnGroup.MONSTER).setDimensions(0.7f, 1.95F).build("evil_forlorn"), 5701896, 4859716);
    ...
    public static final RegistryObject<EntityType<FlamePillar>> FLAME_PILLAR = registerEntity("flame_pillar", () -> EntityType.Builder.<FlamePillar>create(FlamePillar::new, SpawnGroup.MISC).setDimensions(1.5f, 1.5f).makeFireImmune().maxTrackingRange(4).trackingTickInterval(Integer.MAX_VALUE).build("flame_pillar"));
    ...
    public static final RegistryObject<EntityType<AirCombustion>> AIR_COMBUSTION = registerEntity("air_combustion", () -> EntityType.Builder.<AirCombustion>create(AirCombustion::new, SpawnGroup.MISC).setDimensions(1f, 1f).makeFireImmune().maxTrackingRange(16).trackingTickInterval(20).build("air_combustion"));
    public static final RegistryObject<EntityType<MoltenMetal>> MOLTEN_METAL = registerEntity("molten_metal", () -> EntityType.Builder.<MoltenMetal>create(MoltenMetal::new, SpawnGroup.MISC).setDimensions(1f, 0.3f).makeFireImmune().maxTrackingRange(16).trackingTickInterval(20).build("molten_metal"));
    ...
    public static void registerBossDrops() {
        ...
        registerBossDrops("chaos_monarch", WeaponRegistry.WITHERED_WABBAJACK.get(), ItemRegistry.LORD_SOUL_VOID.get(), ArmorRegistry.CHAOS_CROWN.get(), ArmorRegistry.CHAOS_ROBES.get(), Items.NETHERITE_UPGRADE_SMITHING_TEMPLATE, ItemRegistry.BLOOD_VIAL_RECIPE_PAGE.get());
