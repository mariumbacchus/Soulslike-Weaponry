...
import net.soulsweaponry.datagen.loot_tables.EntityLootTables;
...
public class EntityRegistry {
    ...
    public static final EntityType<Remnant> REMNANT = Registry.register(Registries.ENTITY_TYPE ,Identifier.of(ModId, "remnant"), EntityType.Builder.create(Remnant::new, SpawnGroup.CREATURE).dimensions(1F, 1.75F).build());
    public static final EntityType<DarkSorcerer> DARK_SORCERER = Registry.register(Registries.ENTITY_TYPE ,Identifier.of(ModId, "dark_sorcerer"), EntityType.Builder.create(DarkSorcerer::new, SpawnGroup.CREATURE).dimensions(1F, 1.75F).build());
    ...
    public static final EntityType<SoulReaperGhost> SOUL_REAPER_GHOST = Registry.register(Registries.ENTITY_TYPE ,Identifier.of(ModId, "soul_reaper_ghost"), EntityType.Builder.create(SoulReaperGhost::new, SpawnGroup.CREATURE).dimensions(1F, 1.75F).build());
    public static final EntityType<Forlorn> FORLORN = Registry.register(Registries.ENTITY_TYPE ,Identifier.of(ModId, "forlorn"), EntityType.Builder.create(Forlorn::new, SpawnGroup.CREATURE).dimensions(1F, 1.75F).build());
    public static final EntityType<EvilForlorn> EVIL_FORLORN = Registry.register(Registries.ENTITY_TYPE ,Identifier.of(ModId, "evil_forlorn"), EntityType.Builder.create(EvilForlorn::new, SpawnGroup.MONSTER).dimensions(1F, 1.75F).build());
    ...
    public static final EntityType<NightSkull> NIGHT_SKULL = registerEntity("night_skull", EntityType.Builder.<NightSkull>create(NightSkull::new, SpawnGroup.MISC).dimensions(0.5f, 0.75f).maxTrackingRange(15).trackingTickInterval(20).build());
    ...
    public static final EntityType<NightsEdge> NIGHTS_EDGE = registerEntity("nights_edge", EntityType.Builder.create(NightsEdge::new, SpawnGroup.MISC).dimensions(0.75f, 2f).maxTrackingRange(6).trackingTickInterval(Integer.MAX_VALUE).build());
    ...
    private static void registerBossDrops(String id, Item... items) {
        EntityLootTables.BOSS_DROPS.put(id, Lists.newArrayList(items));
    }
}
