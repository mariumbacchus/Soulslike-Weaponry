...
public class EntityRegistry {
    ...
    public static final EntityType<Remnant> REMNANT = Registry.register(Registries.ENTITY_TYPE ,new Identifier(ModId, "remnant"), FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, Remnant::new).dimensions(EntityDimensions.fixed(0.7f, 1.95F)).build()); // 0.6F, 1.95F (zombie hitbox)
    public static final EntityType<DarkSorcerer> DARK_SORCERER = Registry.register(Registries.ENTITY_TYPE ,new Identifier(ModId, "dark_sorcerer"), FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, DarkSorcerer::new).dimensions(EntityDimensions.fixed(0.7f, 1.95F)).build());
    ...
    public static final EntityType<SoulReaperGhost> SOUL_REAPER_GHOST = Registry.register(Registries.ENTITY_TYPE ,new Identifier(ModId, "soul_reaper_ghost"), FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, SoulReaperGhost::new).dimensions(EntityDimensions.fixed(0.7f, 1.95F)).build());
    public static final EntityType<Forlorn> FORLORN = Registry.register(Registries.ENTITY_TYPE ,new Identifier(ModId, "forlorn"), FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, Forlorn::new).dimensions(EntityDimensions.fixed(0.7f, 1.95F)).build());
    public static final EntityType<EvilForlorn> EVIL_FORLORN = Registry.register(Registries.ENTITY_TYPE ,new Identifier(ModId, "evil_forlorn"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, EvilForlorn::new).dimensions(EntityDimensions.fixed(0.7f, 1.95F)).build());
    ...
    public static final EntityType<MoonlightProjectile> VERTICAL_MOONLIGHT_ENTITY_TYPE = Registry.register(Registries.ENTITY_TYPE, new Identifier(ModId, "vertical_moonlight_projectile"), FabricEntityTypeBuilder.<MoonlightProjectile>create(SpawnGroup.MISC, MoonlightProjectile::new).dimensions(EntityDimensions.changing(1F, 3F)).trackRangeChunks(4).trackedUpdateRate(20).build());
    public static final EntityType<MoonlightProjectile> HORIZONTAL_MOONLIGHT_ENTITY_TYPE = Registry.register(Registries.ENTITY_TYPE, new Identifier(ModId, "horizontal_moonlight_projectile"), FabricEntityTypeBuilder.<MoonlightProjectile>create(SpawnGroup.MISC, MoonlightProjectile::new).dimensions(EntityDimensions.changing(3F, 1F)).trackRangeChunks(4).trackedUpdateRate(20).build());
    ...
    public static final EntityType<FlamePillar> FLAME_PILLAR = registerEntity("flame_pillar", FabricEntityTypeBuilder.<FlamePillar>create(SpawnGroup.MISC, FlamePillar::new).dimensions(EntityDimensions.changing(1.5f, 1.5f)).fireImmune().trackRangeChunks(4).trackedUpdateRate(Integer.MAX_VALUE).build());
    ...
    public static final EntityType<MoltenMetal> MOLTEN_METAL = registerEntity("molten_metal", FabricEntityTypeBuilder.<MoltenMetal>create(SpawnGroup.MISC, MoltenMetal::new).dimensions(EntityDimensions.changing(1f, 0.3f)).trackRangeChunks(16).trackedUpdateRate(20).build());
