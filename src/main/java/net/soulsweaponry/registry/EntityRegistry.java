...
public class EntityRegistry {
    ...
    public static final EntityType<DayStalker> DAY_STALKER = Registry.register(Registries.ENTITY_TYPE, new Identifier(ModId, "day_stalker"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, DayStalker::new).dimensions(EntityDimensions.changing(4F, 8F)).build());
