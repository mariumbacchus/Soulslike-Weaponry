...
public class BlockRegistry {
    ...
    public static final Block MOONSTONE_ORE_DEEPSLATE = new ExperienceDroppingBlock(FabricBlockSettings.of(Material.STONE).strength(4.5F, 3.0F).sounds(BlockSoundGroup.DEEPSLATE).luminance(9).requiresTool(), UniformIntProvider.create(4, 8));
