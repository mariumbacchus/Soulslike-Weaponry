...
public class BlockRegistry {
    ...
    public static final RegistryObject<WitheredTallFlower> OLEANDER = registerBlockAndItem("oleander", () -> new WitheredTallFlower(EffectRegistry.DECAY, AbstractBlock.Settings.of(Material.PLANT).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS), Blocks.LARGE_FERN));//TODO might crash because forge bad so custom things has to be directly in constructor or smth idk
