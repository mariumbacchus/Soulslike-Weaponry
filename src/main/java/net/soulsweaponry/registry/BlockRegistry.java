...
public class BlockRegistry {
    ...
    public static final RegistryObject<WitheredFlower> HYDRANGEA = registerBlockAndItem("hydrangea", () -> new WitheredFlower(EffectRegistry.DECAY, AbstractBlock.Settings.of(Material.PLANT).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS)));
    ...
    public static final RegistryObject<WitheredTallFlower> OLEANDER = registerBlockAndItem("oleander", () -> new WitheredTallFlower(EffectRegistry.DECAY, AbstractBlock.Settings.of(Material.PLANT).noCollision().breakInstantly().sounds(BlockSoundGroup.GRASS), Blocks.LARGE_FERN));
    ...
    private static <I extends Block> RegistryObject<Item> registerBlockItem(String name, RegistryObject<I> block) {
        return ItemRegistry.registerItem(name, () -> new BlockItem(block.get(), new Item.Settings().group(SoulsWeaponry.MAIN_GROUP)));
    }
