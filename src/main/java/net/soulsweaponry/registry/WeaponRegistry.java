...
public class WeaponRegistry {
    ...
    public static HolyMoonlightGreatsword HOLY_MOONLIGHT_GREATSWORD = new HolyMoonlightGreatsword(ModToolMaterials.MOONSTONE_OR_VERGLAS, -2.8f,  new FabricItemSettings().fireproof().rarity(Rarity.EPIC), 4);
    public static TrickWeapon HOLY_MOONLIGHT_SWORD = new HolyMoonlightSword(ModToolMaterials.MOONSTONE_OR_VERGLAS, -2.4f,  new FabricItemSettings().fireproof().rarity(Rarity.EPIC));
