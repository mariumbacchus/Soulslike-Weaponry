...
public class WeaponRegistry {
    ...
    public static void register() {
        ...
        FORLORN_SCYTHE = ItemRegistry.registerLegendaryWeapon("forlorn_scythe", () -> new ForlornScythe(ModToolMaterials.LOST_SOUL, new Item.Settings().rarity(Rarity.UNCOMMON)), ConfigConstructor.disable_recipe_forlorn_scythe);
