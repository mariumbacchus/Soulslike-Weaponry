...
public class WeaponRegistry {
    ...
    public static DetonateGroundItem DARKIN_BLADE = new DarkinBlade(ModToolMaterials.CRIMSON_INGOT, -3F, new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC));
    ...
    public static DetonateGroundItem COMET_SPEAR = new CometSpear(ModToolMaterials.MOONSTONE_OR_VERGLAS, -2.6f, new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC));
    ...
    public static ToolItem DAWNBREAKER = new Dawnbreaker(ModToolMaterials.MOONSTONE_OR_VERGLAS, -2.4f, new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC));
    public static ToolItem SOUL_REAPER = new SoulReaper(ModToolMaterials.MOONSTONE_OR_VERGLAS, -3f, new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC));
