...
public class WeaponRegistry {
    ...
    public static void register() {
        ...
        BLOODTHIRSTER = ItemRegistry.registerWeaponItem("bloodthirster", () -> new Bloodthirster(ModToolMaterials.CRIMSON_INGOT, new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_bloodthirster);
        DARKIN_BLADE = ItemRegistry.registerWeaponItem("darkin_blade", () -> new DarkinBlade(ModToolMaterials.CRIMSON_INGOT, new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_darkin_blade);
        ...
        WITHERED_WABBAJACK = ItemRegistry.registerWeaponItem("withered_wabbajack", () -> new WitheredWabbajack(ModToolMaterials.MOONSTONE_OR_VERGLAS, new Item.Settings().group(MAIN_GROUP).rarity(Rarity.EPIC).fireproof()), ConfigConstructor.disable_recipe_withered_wabbajack);
        ...
        DRAGONSLAYER_SWORDSPEAR = ItemRegistry.registerWeaponItem("dragonslayer_swordspear", () -> new DragonslayerSwordspear(ModToolMaterials.MOONSTONE_OR_VERGLAS, new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_dragonslayer_swordspear);
        ...
        NIGHTFALL = ItemRegistry.registerWeaponItem("nightfall", () -> new Nightfall(ModToolMaterials.IRON_BLOCK, new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_nightfall);
        COMET_SPEAR = ItemRegistry.registerWeaponItem("comet_spear", () -> new CometSpear(ModToolMaterials.MOONSTONE_OR_VERGLAS, new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_comet_spear);
        ...
        GALEFORCE = ItemRegistry.registerWeaponItem("galeforce", () -> new Galeforce(new Item.Settings().group(MAIN_GROUP).fireproof().maxDamage(1300).rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_galeforce);
        ...
        DAWNBREAKER = ItemRegistry.registerWeaponItem("dawnbreaker", () -> new Dawnbreaker(ModToolMaterials.MOONSTONE_OR_VERGLAS, new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_dawnbreaker);
        SOUL_REAPER = ItemRegistry.registerWeaponItem("soul_reaper", () -> new SoulReaper(ModToolMaterials.MOONSTONE_OR_VERGLAS, new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_soul_reaper);
        ...
        SKOFNUNG = ItemRegistry.registerWeaponItem("skofnung", () -> new Skofnung(ModToolMaterials.MOONSTONE_OR_VERGLAS, new Item.Settings().group(MAIN_GROUP).rarity(Rarity.EPIC).fireproof()), ConfigConstructor.disable_recipe_skofnung);
        MJOLNIR = ItemRegistry.registerWeaponItem("mjolnir", () -> new Mjolnir(ModToolMaterials.MOONSTONE_OR_VERGLAS, new Item.Settings().group(MAIN_GROUP).rarity(Rarity.EPIC).fireproof()), ConfigConstructor.disable_recipe_mjolnir);
        FREYR_SWORD = ItemRegistry.registerWeaponItem("freyr_sword", () -> new FreyrSword(ModToolMaterials.MOONSTONE_OR_VERGLAS, new Item.Settings().group(MAIN_GROUP).rarity(Rarity.EPIC).fireproof()), ConfigConstructor.disable_recipe_sword_of_freyr);
        ...
        CRUCIBLE_SWORD = ItemRegistry.registerWeaponItem("crucible_sword", () -> new CrucibleSword(ModToolMaterials.MOONSTONE_OR_VERGLAS, new Item.Settings().group(MAIN_GROUP).rarity(Rarity.EPIC).fireproof()), ConfigConstructor.disable_recipe_crucible_sword);
        DARKIN_SCYTHE_PRE = ItemRegistry.registerWeaponItem("darkin_scythe_pre", () -> new DarkinScythePre(ModToolMaterials.MOONSTONE_OR_VERGLAS, new Item.Settings().group(MAIN_GROUP).rarity(Rarity.EPIC).fireproof()), ConfigConstructor.disable_recipe_darkin_scythe);
        ...
        DRAUPNIR_SPEAR = ItemRegistry.registerWeaponItem("draupnir_spear", () -> new DraupnirSpear(ModToolMaterials.MOONSTONE_OR_VERGLAS, new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_draupnir_spear);
        ...
        HOLY_MOONLIGHT_SWORD = ItemRegistry.registerWeaponItem("holy_moonlight_sword", () -> new HolyMoonlightSword(ModToolMaterials.MOONSTONE_OR_VERGLAS,  new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_holy_moonlight_sword);
        FROSTMOURNE = ItemRegistry.registerWeaponItem("frostmourne", () -> new Frostmourne(ModToolMaterials.MOONSTONE_OR_VERGLAS,  new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_frostmourne);
        MASTER_SWORD = ItemRegistry.registerWeaponItem("master_sword", () -> new MasterSword(ModToolMaterials.MOONSTONE_OR_VERGLAS, new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_master_sword);
        NIGHTS_EDGE_ITEM = ItemRegistry.registerWeaponItem("nights_edge_item", () -> new NightsEdgeItem(ModToolMaterials.MOONSTONE_OR_VERGLAS, new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_nights_edge);
        EMPOWERED_DAWNBREAKER = ItemRegistry.registerWeaponItem("empowered_dawnbreaker", () -> new EmpoweredDawnbreaker(ModToolMaterials.MOONSTONE_OR_VERGLAS, new Item.Settings().group(MAIN_GROUP).fireproof().rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_empowered_dawnbreaker);
        KRAKEN_SLAYER = ItemRegistry.registerWeaponItem("kraken_slayer", () -> new KrakenSlayer(new Item.Settings().group(MAIN_GROUP).maxDamage(1258).fireproof().rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_kraken_slayer_bow);
        KRAKEN_SLAYER_CROSSBOW = ItemRegistry.registerWeaponItem("kraken_slayer_crossbow", () -> new KrakenSlayerCrossbow(new Item.Settings().group(MAIN_GROUP).fireproof().maxDamage(1258).rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_kraken_slayer_crossbow);
        DARKMOON_LONGBOW = ItemRegistry.registerWeaponItem("darkmoon_longbow", () -> new DarkmoonLongbow(new Item.Settings().group(MAIN_GROUP).fireproof().maxDamage(1400).rarity(Rarity.EPIC)), ConfigConstructor.disable_recipe_darkmoon_longbow);
    }
}
