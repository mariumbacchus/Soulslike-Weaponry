...
public class WeaponRegistry {
    ...
    public static TrickWeapon KIRKHAMMER_SILVER_SWORD = new TrickWeapon(ModToolMaterials.IRON_BLOCK, 1, -2.4f, new Item.Settings().group(MAIN_GROUP).rarity(Rarity.EPIC), 0, false);
