...
public class WeaponRegistry {
    ...
    public static NightsEdgeItem NIGHTS_EDGE_ITEM = new NightsEdgeItem(ModToolMaterials.MOONSTONE_OR_VERGLAS, -2.8f, new FabricItemSettings().fireproof().rarity(Rarity.EPIC));
