...
public class ConfigConstructor extends MidnightConfig {
    ...
    @Entry public static int blunderbuss_posture_loss = 30;
    @Entry public static int blunderbuss_posture_loss_per_enchant_level = 3;
    ...
    @Entry public static int gatling_gun_posture_loss = 10;
    @Entry public static int gatling_gun_posture_loss_per_enchant_level = 3;
    ...
    @Entry public static int hunter_pistol_posture_loss = 50;
    @Entry public static int hunter_pistol_posture_loss_per_enchant_level = 10;
