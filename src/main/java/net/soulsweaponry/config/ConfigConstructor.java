...
public class ConfigConstructor extends MidnightConfig {
    ...
    @Entry public static float darkin_scythe_prime_ability_cooldown = 400;
    @Entry public static float darkin_scythe_prime_ability_min_cooldown = 100;
    ...
    @Entry public static float shadow_assassin_scythe_shadow_step_bonus_damage = 2;
    ...
    @Entry public static float shadow_assassin_scythe_ability_cooldown = 300;
    @Entry public static float shadow_assassin_scythe_ability_min_cooldown = 100;
    ...
    @Entry public static float shadow_assassin_scythe_ticks_before_dismount = 120;
