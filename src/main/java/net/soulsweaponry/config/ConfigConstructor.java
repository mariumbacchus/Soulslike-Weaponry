...
public class ConfigConstructor extends MidnightConfig {
    ...
    @Entry public static float lifesteal_item_base_healing = 2;
    @Entry public static boolean lifesteal_item_heal_scales = true;
    @Entry public static float lifesteal_item_cooldown = 60;
    @Entry public static float lifesteal_item_min_cooldown = 10;
