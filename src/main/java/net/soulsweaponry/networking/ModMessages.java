...
public class ModMessages {
    ...
    public static void register() {
        ...
        net.messageBuilder(UTDamageCooldownSyncS2C.class, id(), NetworkDirection.PLAY_TO_CLIENT).decoder(UTDamageCooldownSyncS2C::new).encoder(UTDamageCooldownSyncS2C::toBytes).consumer(UTDamageCooldownSyncS2C::handle).add();
