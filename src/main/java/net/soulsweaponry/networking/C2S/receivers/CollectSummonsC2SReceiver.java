...
import net.soulsweaponry.networking.C2S.packets.CollectSummonsC2S;
import net.soulsweaponry.particles.ParticleEvents;
import net.soulsweaponry.particles.ParticleHandler;

public class CollectSummonsC2SReceiver {

    public static void receive(CollectSummonsC2S pkt, ServerPlayNetworking.Context ctx) {
